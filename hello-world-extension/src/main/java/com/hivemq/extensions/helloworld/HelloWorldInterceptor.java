 ...
 * package com.hivemq;
 * 
 * import com.hivemq.extension.sdk.api.annotations.NotNull; import
 ...
 * PublishInboundInput; import
 * com.hivemq.extension.sdk.api.interceptor.publish.parameter.
 * PublishInboundOutput; import
 * com.hivemq.extension.sdk.api.packets.publish.ModifiablePublishPacket;
 * 
 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * @Override public void onInboundPublish(final @NotNull PublishInboundInput
		 * publishInboundInput, final @NotNull PublishInboundOutput
		 * publishInboundOutput) { final ModifiablePublishPacket publishPacket =
		 * publishInboundOutput.getPublishPacket(); if
		 * ("hello/world".equals(publishPacket.getTopic())) { final ByteBuffer payload =
